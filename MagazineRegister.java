...
public class MagazineRegister {
    ...
    /**
     * Iterator to run through arraylist magazinecollection
     * @return Returns iterator for magazinecollection
     */
    ...
    {
        Magazine magazine = searchForDuplicates(title);
    ...
    public Magazine searchForDuplicates (String title) {
        Magazine foundMagazine = null;
