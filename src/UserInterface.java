...
public class UserInterface {
    ...
    private void addNewMagazine()
    {
        ...
        if(title.length()<3){
            System.out.println("*Error, title must be at least 3 characters long*");
        }
        else{
    ...
    private void deleteMagazine()
    {
        ...
        Magazine found = this.magazineReg.searchForDuplicates(title);

        if (found == null){
            System.out.println("* No magazine found to delete *");
        } else {
